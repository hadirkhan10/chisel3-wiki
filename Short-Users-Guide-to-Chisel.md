This is a brief guide to Chisel hardware description language.  To get started using Chisel, it's recommended that this document and the [Chisel-tutorial](https://gitub.com/ucb-bar/chisel-tutorial)
