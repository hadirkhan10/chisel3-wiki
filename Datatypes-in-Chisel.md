...
> There is a new experimental type **Interval** which gives the developer more control of the type by allowing the definition of an IntervalRange.  See: [Experimental - Interval Type](Experimental---Interval-Type)
